...
Finally, to allow for faster computation, API calls can be called in parallel using `parallel = TRUE`. This is recommended for large requests, although it is noted that this API call tends to still be rather slow.
